...
# Currently the lsp doesn't compile with mlx, need to wait for the PR to get merged
	opam pin add jsonrpc.dev "https://github.com/davesnx/ocaml-lsp.git#0988f2b9b0ea6822ed0f8a970b7eaf807605f772" -y
	opam pin add lsp.dev "https://github.com/davesnx/ocaml-lsp.git#0988f2b9b0ea6822ed0f8a970b7eaf807605f772" -y
